...
namespace ModelManagement.Core.Data.Data.Mapping
{
    public class JobOfferMap:EntityTypeConfiguration<JobOffer>
    {
        public JobOfferMap()
        {
            ...
            HasOptional(t => t.JobOffer_ModelUserId).WithMany(t => t.User_JobOffers).HasForeignKey(k => k.ModelUserId);
            ...
            Property(t => t.ModelUserId).HasMaxLength(50).HasColumnName("MODEL_USER_ID");
